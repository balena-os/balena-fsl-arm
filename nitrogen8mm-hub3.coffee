...
WRITE_BALENA_UBOOT = 'Update BalenaOS imx-boot in the mmcblk0boot0 partition. imx-boot is present in /mnt/boot/ in the HostOS, as well as in the resin-boot partition of the downloaded BalenaOS image, e.g. dd if=/mnt/boot/imx-boot of=/dev/mmcblk0boot0 seek=33 bs=1K and then re-boot the device.'
...
module.exports =
	...
	gettingStartedLink:
		windows: 'https://docs.resin.io/nitrogen8mm-hub3/nodejs/getting-started/#adding-your-first-device'
		osx: 'https://docs.resin.io/nitrogen8mm-hub3/nodejs/getting-started/#adding-your-first-device'
		linux: 'https://docs.resin.io/nitrogen8mm-hub3/nodejs/getting-started/#adding-your-first-device'

	supportsBlink: false

	yocto:
		machine: 'nitrogen8mm-hub3'
		image: 'resin-image'
		fstype: 'resinos-img'
		version: 'yocto-warrior'
		deployArtifact: 'resin-image-nitrogen8mm-hub3.resinos-img'
		compressed: true
